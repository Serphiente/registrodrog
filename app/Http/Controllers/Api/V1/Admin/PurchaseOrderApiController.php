...
class PurchaseOrderApiController extends Controller
{
    public function index()
    {
        ...
        return new PurchaseOrderResource(PurchaseOrder::with(['client', 'client_contact'])->get());
    ...
    public function show(PurchaseOrder $purchaseOrder)
    {
        ...
        return new PurchaseOrderResource($purchaseOrder->load(['client', 'client_contact']));
