...
@can('client_contact_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route("admin.client-contacts.create") }}">
...
<div class="card">
    <div class="card-header">
        {{ trans('cruds.clientContact.title_singular') }} {{ trans('global.list') }}
    </div>

    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-ClientContact">
            <thead>
                <tr>
                    <th width="10">
...
@can('client_contact_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.client-contacts.massDestroy') }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.client-contacts.index') }}",
    columns: [
...
{ data: 'another_info', name: 'another_info' },
{ data: 'actions', name: '{{ trans('global.actions') }}' }
    ],
    order: [[ 1, 'desc' ]],
    pageLength: 100,
  };
  $('.datatable-ClientContact').DataTable(dtOverrideGlobals);
